 ...
 * websocket 服务端
 * 请求路径：
 * websocket = new WebSocket("ws://localhost:9080/websocket/20");
 * websocket =  new WebSocket("websocket/${cid}".replace("http","ws"));
 */
...
public class WebSocketServer {
    ...
    public void onMessage(String message, Session session) throws IOException {
        ...
        if (message != null && !message.equals("")) {
            webSocketSet.get(message).sendMessage(message);
        }
